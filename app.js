...
mongoose.connect(`mongodb+srv://Hatomia:hatomiatruong@fashale-hpduv.gcp.mongodb.net/test?retryWrites=true&w=majority`, { useNewUrlParser: true });
...
//Setup router
app.use(`/${systemConfig.prefixBackend}`, require(__path_routes + 'backend/index'));
...
app.use( async (err, req, res, next) => {
  ...
  if (systemConfig.env == "dev") {
    ...
    res.render(__path_views_backend + 'pages/error', { moduleTitle: 'ERROR PAGE', pageTitle: 'Page Not Found' });
  }
